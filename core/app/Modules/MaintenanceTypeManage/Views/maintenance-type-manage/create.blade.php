...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['url' => '/admin/maintenance/type/maintenance-type-manage', 'class' => 'form-horizontal', 'files' => true]) !!}

            @include ('MaintenanceTypeManage::maintenance-type-manage.form')
