@extends('layouts.master') @section('title','Add Account')
@section('css')
    <link rel="stylesheet"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                            {!! Form::select('bank', $banks, Input::old('bank'),['class'=>'chosen','style'=>'width:100%;font-family:\'FontAwesome\'','data-placeholder'=>'Select Bank']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" align="right">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                            <input type="text" class="form-control @if($errors->has('branch')) error @endif" id="branch"
                                                   name="branch" placeholder="Input branch">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" align="right">
