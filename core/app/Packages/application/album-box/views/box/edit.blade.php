@extends('layouts.master') @section('title','Box Size')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li>
    	<a href="{{url('product/list')}}">Size List</a>
  	</li>
  	<li class="active">Box Size</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
      			...
      			<a class="pull-right btn btn-danger" href="{{url('/albumbox/list')}}"><i class="fa fa-arrow-left"></i> Back</a>
      		</div>
