@extends('layouts.master') @section('title','Box List')
@section('css')
    <style type="text/css">
        .switch.switch-sm {
            width: 30px;
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="javascript:;">Box List</a>
        </li>
        <li class="active">Box List</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Box List</strong></div>
                        <div class="col-xs-6 text-right">
                            @if($permissions)
                            <button class="btn btn-success" onclick="window.location.href='{{url('albumbox/add')}}'"><i
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = generateTable('.datatable', '{{url('albumbox/json/list')}}', [], []);
            ...
            table.on('draw.dt', function () {
                ...
                $('.datatable .menu-activate').change(function () {
                    if ($(this).prop('checked') == true) {
                        ajaxRequest('{{url('albumbox/status')}}', {
                            'id': $(this).val(),
                            'status': 1
                        }, 'post', successFunc);
                    } else {
