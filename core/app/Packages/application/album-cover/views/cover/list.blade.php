@extends('layouts.master') @section('title','Cover List')
@section('css')
    <style type="text/css">
        .switch.switch-sm {
            width: 30px;
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="javascript:;">Cover List</a>
        </li>
        <li class="active">Cover List</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Cover List</strong></div>
                        <div class="col-xs-6 text-right">
                            @if($permissions)
                            <button class="btn btn-success" onclick="window.location.href='{{url('albumCover/add')}}'"><i
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = generateTable('.datatable', '{{url('albumCover/json/list')}}', [], []);
            ...
            table.on('draw.dt', function () {
                ...
                $('.datatable .menu-activate').change(function () {
                    if ($(this).prop('checked') == true) {
                        ajaxRequest('{{url('albumCover/status')}}', {
                            'id': $(this).val(),
                            'status': 1
                        }, 'post', successFunc);
                    } else {
