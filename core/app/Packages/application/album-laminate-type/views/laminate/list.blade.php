@extends('layouts.master') @section('title','Laminate List')
@section('css')
    <style type="text/css">
        .switch.switch-sm {
            width: 30px;
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="javascript:;">Laminate List</a>
        </li>
        <li class="active">Laminate List</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Laminate List</strong></div>
                        <div class="col-xs-6 text-right">
                            @if($permissions)
                            <button class="btn btn-success" onclick="window.location.href='{{url('laminateType/add')}}'"><i
                ...
                <div class="panel-body">
                    <table id="print_table" name="print_table"
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="text-center" style="font-weight:normal;">Cover</th>
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = generateTable('.datatable', '{{url('laminateType/json/list')}}', [], []);
            ...
            table.on('draw.dt', function () {
                ...
                $('.datatable .menu-activate').change(function () {
                    if ($(this).prop('checked') == true) {
                        ajaxRequest('{{url('laminateType/status')}}', {
                            'id': $(this).val(),
                            'status': 1
                        }, 'post', successFunc);
                    } else {
