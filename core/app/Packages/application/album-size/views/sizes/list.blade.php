@extends('layouts.master') @section('title','Sizes List')
@section('css')
    <style type="text/css">
        .switch.switch-sm {
            width: 30px;
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="javascript:;">Sizes Management</a>
        </li>
        <li class="active">Sizes List</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Sizes List</strong></div>
                        <div class="col-xs-6 text-right">
                            @if($permissions)
                            <button class="btn btn-success" onclick="window.location.href='{{url('sizes/add')}}'"><i
                ...
                <div class="panel-body">
                    <table id="print_table" name="print_table"
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="text-center" style="font-weight:normal;">Size</th>
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = generateTable('.datatable', '{{url('sizes/json/list')}}', [], []);
