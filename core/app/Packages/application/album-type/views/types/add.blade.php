@extends('layouts.master') @section('title','Add Album Type')
@section('css')
    <style type="text/css">
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">Add Album Type</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <strong>Add Album Type</strong>
                </div>
                <div class="panel-body ">
                    <form role="form" class="form-horizontal form-validation" method="post">
                        ...
                        <div class="form-group{{ $errors->has('type')? ' has-error':'' }}">
                            <label class="col-sm-3 control-label required">Album Type</label>
