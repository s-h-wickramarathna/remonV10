@extends('layouts.master') @section('title','Edit Album Type')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li>
    	<a href="javascript:;">Album Type Management</a>
  	</li>
  	<li>
    	<a href="{{url('product/list')}}">Type List</a>
  	</li>
  	<li class="active">Edit Album Type</li>
</ol>
<div class="row">
	<div class="col-xs-12">
