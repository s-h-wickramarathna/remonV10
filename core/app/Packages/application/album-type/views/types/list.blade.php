@extends('layouts.master') @section('title','Album Type')
@section('css')
    <style type="text/css">
        .switch.switch-sm {
            width: 30px;
        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Album Type</strong></div>
                        <div class="col-xs-6 text-right">
                            @if($permissions)
                            <button class="btn btn-success" onclick="window.location.href='{{url('albumType/add')}}'"><i
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = generateTable('.datatable', '{{url('albumType/json/list')}}', [], []);
            ...
            table.on('draw.dt', function () {
                ...
                $('.datatable .menu-activate').change(function () {
                    if ($(this).prop('checked') == true) {
                        ajaxRequest('{{url('albumType/status')}}', {
                            'id': $(this).val(),
                            'status': 1
                        }, 'post', successFunc);
                    } else {
