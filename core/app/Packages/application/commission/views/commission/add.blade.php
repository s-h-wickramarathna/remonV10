@extends('layouts.master') @section('title','Add Commission')
@section('css')
    <link rel="stylesheet"
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">Add Commission</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                            {!! Form::select('marketeer', $marketeers, Input::old('marketeer'),['class'=>'chosen','style'=>'width:100%;font-family:\'FontAwesome\'','data-placeholder'=>'Select Marketeer']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" align="right">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="month_picker_txt"
                                                       name="month_picker_txt" placeholder="Select a Month"
