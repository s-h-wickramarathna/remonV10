@extends('layouts.master') @section('title','Discount Rule List')
@section('css')
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">Discount Rule List</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row">
                        <div class="col-xs-6"><strong>Discount Rule List</strong></div>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 right">
                            ...
                            <button class="btn btn-success"
                                    onclick="window.location.href='{{url('discount/rule/add')}}'"><i
                    ...
                    <table style="margin-top: 0px" hidden="true" id="pr_id"
                        ...
                        <tr style="background: rgba(204, 204, 204, 0.21);">
                            <th class="text-center" width="30%" style="font-weight:normal;">Rule Name</th>
                            <th class="text-center" width="30%" style="font-weight:normal;">Rule Type</th>
                            <th class="text-center" width="10%" style="font-weight:normal;">View Rule</th>
                            <th class="text-center" width="10%" style="font-weight:normal;">Status</th>
                        </tr>
                        </thead>
                    </table>
                </div>
        ...
        $(document).ready(function () {
            ...
            $('#pr_id').on('draw.dt', function () {
                ...
                $('.menu-activate').change(function () {
                    if ($(this).prop('checked') == true) {
                        ...
                        if (y) {
                            ajaxRequest('{{url('discount/rule/status')}}', {
                                'id': $(this).val(),
                                'status': 1
                            }, 'post', successFunc);
                        } else {
            ...
            $('#btn-find').click(function () {
                ...
                $('.datatable').dataTable({
                    ...
                    'ajax': '{{url('discount/rule/json/list')}}?status=' + status,
                    "pageLength": 25,
