                        ...
                        <div class="col-xs-5">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" disabled
                                               name="customer_address" value="{{Input::old('customer_address')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control" disabled
                                               name="customer_contact" value="{{Input::old('customer_contact')}}"
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <div class="checkbox checkbox-success">
                                        ...
                                        <input id="checkbox_p_only" onclick="clear_album(1)" class="styled calc"
                                               name="checkbox_p_only" type="checkbox" {{(Input::old("checkbox_p_only") ? "checked":"")}}>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                    <div class="checkbox checkbox-success">
                                        ...
                                        <input id="checkbox_story" onclick="clear_album(2)" class="styled calc"
                                               type="checkbox" name="checkbox_story">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                    <div class="checkbox checkbox-success">
                                        ...
                                        <input id="checkbox_magazine" onclick="clear_album(3)" class="styled calc"
                                               type="checkbox" name="checkbox_magazine">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Album</label>
                            ...
                            <div class="form-group">
                                <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Lamination</label>
                                @foreach($lamination_types as $key => $lamination_type)
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <input type="checkbox"
                                               name="radio_lamination_type[]" value="{{$lamination_type->id}}">
                                        <label for="checkbox">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12 required">Paper Type</label>
                                @foreach($paper_types as $key => $paper_type)
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <input type="checkbox"
                                               name="radio_paper_type[]" value="{{$paper_type->id}}">
                                        <label for="checkbox">
                                            {{$paper_type->type}}
                                        </label>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Cover</label>
                                @foreach($album_covers as $key => $album_cover)
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <input type="checkbox"
                                               name="radio_cover[]" value="{{$album_cover->id}}">
                                        <label for="checkbox">
                                            {{$album_cover->cover}}
                                        </label>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Box</label>
                                @foreach($boxes as $key => $box)
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <input type="checkbox"
                                               name="radio_box[]" value="{{$box->id}}">
                                        <label for="checkbox">
                                            {{$box->box}}
                                        </label>
                                    </div>
                        ...
                        <div class="col-xs-5 col-xs-offset-1">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                               name="job_no" value="{{$job_no}}" required>
                                               <span class="input-group-addon"><i
