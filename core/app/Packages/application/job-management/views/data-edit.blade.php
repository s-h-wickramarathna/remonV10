@extends('layouts.master') @section('title','Edit Job Data')
@section('css')
    <style type="text/css">
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="{{url('job/index')}}">Job Data List</a>
        </li>
        <li class="active">Edit Job Data</li>
    </ol>
    <div class="row">
        <div class="col-xs-12">
                ...
                <div class="panel-body ">
                    <form box="form" class="form-horizontal form-validation" method="post">
                        ...
                        <div class="form-group{{ $errors->has('name')? ' has-error':'' }}">
                            ...
                            <div class="col-sm-6">
                                {!! Form::select('parent', $jobs, $parent_data,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Choose Parent']) !!}
