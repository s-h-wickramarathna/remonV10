...
@section('content')
    <ol class="breadcrumb">
        ...
        @if(trim($user->roles[0]->name) != 'customer')
            <div class="pull-right"><a href="{{url('job/qr/list/'.$job->id)}}" data-placement="top"><i
                            class="fa fa-qrcode fa-2x"></i> QR</a></div>@endif
    </ol>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-heading clearfix">
                            ...
                            <div class="btn-group col-sm-4 pull-right">
                                <form role="form" method="get" action="{{url('job/new/search/'.$job->id)}}">
                                    <div class="input-group">

                                        <input type="hidden" name="album_qr" value="{{$job->id}}"/>
                                        <input type="hidden" name="album" value="{{$qr}}"/>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered bordered table-striped table-condensed"
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td align="center"><input type="checkbox" name="radio_1[]" value="1" disabled
                                                              @if(in_array(1,$printer_1)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_2[]" value="1" disabled
                                                              @if(in_array(1,$printer_2)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_3[]" value="1" disabled
                                                              @if(in_array(1,$printer_3)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_4[]" value="1" disabled
                                                              @if(in_array(1,$printer_4)) checked @endif></td>
                                    <td align="center"><input type="checkbox" name="radio_5[]" value="1" disabled
                                                              @if(in_array(1,$printer_5)) checked @endif></td>
                                </tr>
                                <tr>
                                    <td>
                                        Konika
                                    </td>
                                    <td align="center"><input type="checkbox" name="radio_1[]" value="2" disabled
                                                              @if(in_array(2,$printer_1)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_2[]" value="2" disabled
                                                              @if(in_array(2,$printer_2)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_3[]" value="2" disabled
                                                              @if(in_array(2,$printer_3)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_4[]" value="2" disabled
                                                              @if(in_array(2,$printer_4)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_5[]" value="2" disabled
                                                              @if(in_array(2,$printer_5)) checked @endif ></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
