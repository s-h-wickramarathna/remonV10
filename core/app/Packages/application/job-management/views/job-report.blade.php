                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 input-daterange">
                                    <input type="text" autocomplete="off" class="form-control" name="from"
                                           id="from"
                                           placeholder="By Due Date" value="{{$from}}"/>
                                </div>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="pull-right" style="padding-right: 10px">
                                        <a href="pending-report" class="btn btn-warning" data-toggle="tooltip"
                            ...
                            @if($user->id == 1 || $user->hasAnyAccess(['job.list']))
                                <div class="col-md-2 pull-right">
                                    ...
                                    <div class="row pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <form role="form" method="get" action="{{url('job/pending-report/print')}}">
                                            <input type="hidden" name="invoice_no" value="{{$invoice_no}}">
                                            <input type="hidden" name="customer" value="{{$customer}}">
                                            <input type="hidden" name="marketeer" value="{{$marketeer}}">
                                            <input type="hidden" name="from" value="{{$from}}">
