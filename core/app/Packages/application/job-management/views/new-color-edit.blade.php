                        ...
                        <div class="panel-body">
                            <table class="table table-bordered bordered table-striped table-condensed"
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td align="center"><input type="checkbox" name="radio_1[]" value="1"
                                                              @if(in_array(1,$printer_1)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_2[]" value="1"
                                                              @if(in_array(1,$printer_2)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_3[]" value="1"
                                                              @if(in_array(1,$printer_3)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_4[]" value="1"
                                                              @if(in_array(1,$printer_4)) checked @endif></td>
                                    <td align="center"><input type="checkbox" name="radio_5[]" value="1"
                                ...
                                <tr>
                                    ...
                                    <td align="center"><input type="checkbox" name="radio_1[]" value="2"
                                                              @if(in_array(2,$printer_1)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_2[]" value="2"
                                                              @if(in_array(2,$printer_2)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_3[]" value="2"
                                                              @if(in_array(2,$printer_3)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_4[]" value="2"
                                                              @if(in_array(2,$printer_4)) checked @endif ></td>
                                    <td align="center"><input type="checkbox" name="radio_5[]" value="2"
