                            ...
                            <table class="table table-bordered bordered table-striped table-condensed"
                                ...
                                <tr>
                                    ...
                                    @foreach($job->data as $key => $data)
                                        @if(!is_numeric(strpos(strtolower($job_data[$pos]->name),'cover')))
                                            <td>
                                                {{$data->master->name}}
                                            </td>
                                ...
                                <?php $i = 0; ?>
                                <?php $cover_1 = [];$cover_2 = [];$cover_3 = [];$cover_4 = [];$cover_5 = [];?>
                                <?php
                                foreach ($job->data as $cover) {
                                    if (is_numeric(strpos(strtolower($cover->master->super->name), 'cover')) && $cover->master->depth > 0) {
                                        if (1 == $cover->album_no) {
                                            $cover_1[] = array('id' => $cover->id, 'data' => $cover->job_master_data_id);
                                        } else if (2 == $cover->album_no) {
                                            $cover_2[] = array('id' => $cover->id, 'data' => $cover->job_master_data_id);
                                        } else if (3 == $cover->album_no) {
                                            $cover_3[] = array('id' => $cover->id, 'data' => $cover->job_master_data_id);
                                        } else if (4 == $cover->album_no) {
                                            $cover_4[] = array('id' => $cover->id, 'data' => $cover->job_master_data_id);
                                        } else if (5 == $cover->album_no) {
                                            $cover_5[] = array('id' => $cover->id, 'data' => $cover->job_master_data_id);
                                        }
                                    }
                                }
                                ?>
                                @foreach($job_data as $key => $data)
                                    @if($key > 1)
                                        @if(is_numeric(strpos(strtolower($data->name),'cover')))
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <input type="hidden" value="{{$cover_1[$i]['id']}}"
                                                           name="id_1_{{$data->id}}"/>
                                                    <select name="data_1_{{$data->id}}" class="chosen"
                                                            style="width:100%;font-family:'FontAwesome', 'Open Sans', sans-serif">
                                                        @foreach($data->children as $child)
                                                            <option value="{{$child->id}}"
                                                                    @if($cover_1[$i]['data'] == $child->id) selected @endif>{{$child->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td align="center">
                                                    <input type="hidden" value="{{$cover_2[$i]['id']}}"
                                                           name="id_2_{{$data->id}}"/>
                                                    <select name="data_2_{{$data->id}}" class="chosen"
                                                            style="width:100%;font-family:'FontAwesome', 'Open Sans', sans-serif">
                                                        @foreach($data->children as $child)
                                                            <option value="{{$child->id}}"
                                                                    @if($cover_2[$i]['data'] == $child->id) selected @endif>{{$child->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td align="center">
                                                    <input type="hidden" value="{{$cover_3[$i]['id']}}"
                                                           name="id_3_{{$data->id}}"/>
                                                    <select name="data_3_{{$data->id}}" class="chosen"
                                                            style="width:100%;font-family:'FontAwesome', 'Open Sans', sans-serif">
                                                        @foreach($data->children as $child)
                                                            <option value="{{$child->id}}"
                                                                    @if($cover_3[$i]['data'] == $child->id) selected @endif>{{$child->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td align="center">
                                                    <input type="hidden" value="{{$cover_4[$i]['id']}}"
                                                           name="id_4_{{$data->id}}"/>
                                                    <select name="data_4_{{$data->id}}" class="chosen"
                                                            style="width:100%;font-family:'FontAwesome', 'Open Sans', sans-serif">
                                                        @foreach($data->children as $child)
                                                            <option value="{{$child->id}}"
                                                                    @if($cover_4[$i]['data'] == $child->id) selected @endif>{{$child->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td align="center">
                                                    <input type="hidden" value="{{$cover_5[$i]['id']}}"
                                                           name="id_5_{{$data->id}}"/>
                                                    <select name="data_5_{{$data->id}}" class="chosen"
                                                            style="width:100%;font-family:'FontAwesome', 'Open Sans', sans-serif">
                                                        @foreach($data->children as $child)
                                                            <option value="{{$child->id}}"
                                                                    @if($cover_5[$i]['data'] == $child->id) selected @endif>{{$child->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td align="center"><input type="number" class="form-control" name="page_1"
                                                              value="{{$page_1}}"></td>
                                    <td align="center"><input type="number" class="form-control" name="page_2"
                                                              value="{{$page_2}}"></td>
                                    <td align="center"><input type="number" class="form-control" name="page_3"
                                                              value="{{$page_3}}"></td>
                                    <td align="center"><input type="number" class="form-control" name="page_4"
                                                              value="{{$page_4}}"></td>
                                    <td align="center"><input type="number" class="form-control" name="page_5"
                                                              value="{{$page_5}}"></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <?php $printer_1 = [];$printer_2 = [];$printer_3 = [];$printer_4 = [];$printer_5 = [];?>
                                    <?php
                                    foreach ($job->printer as $printer) {
                                        if (1 == $printer->album_id) {
                                            $printer_1[] = $printer->printer;
                                        } else if (2 == $printer->album_id) {
                                            $printer_2[] = $printer->printer;
                                        } else if (3 == $printer->album_id) {
                                            $printer_3[] = $printer->printer;
                                        } else if (4 == $printer->album_id) {
                                            $printer_4[] = $printer->printer;
                                        } else if (5 == $printer->album_id) {
                                            $printer_5[] = $printer->printer;
                                        }
                                    }
                                    ?>
                                    <td align="center">@if(in_array(1,$printer_1))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(1,$printer_2))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(1,$printer_3))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(1,$printer_4))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(1,$printer_5))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="center">@if(in_array(2,$printer_1))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(2,$printer_2))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(2,$printer_3))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(2,$printer_4))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                    <td align="center">@if(in_array(2,$printer_5))<span class="badge badge-info"><i
                                                    class="fa fa-check"></i></span>@else - @endif</td>
                                </tr>
                                </tbody>
                            </table>
