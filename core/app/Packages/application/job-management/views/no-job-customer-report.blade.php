@extends('layouts.master') @section('title','No-Job Customer List')
@section('css')
...
@section('content')
    <ol class="breadcrumb">
        ...
        <li>
            <a href="javascript:">Report Management</a>
        </li>
        <li class="active">No-Job Customer List</li>
    </ol>
    <div class="col">
        <div class="col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="pull-right" style="padding-right: 10px">
                                        <a href="no-job-customers" class="btn btn-warning" data-toggle="tooltip"
        ...
        <div class="col-md-12">
            <div class="box box-widget box-list box-primary">
                <div class="box-body" style="max-height: 500px;min-height: 500px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            @if($user->id == 1 || $user->hasAnyAccess(['job.list']))
                                <div class="col-md-2 pull-right">

                                    <div class="row pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <form role="form" method="get" action="{{url('job/report/no-job-customers/print')}}">
                                            <input type="hidden" name="customer" value="{{$customer}}">
                                            <input type="hidden" name="marketeer" value="{{$marketeer}}">
                                            <input type="hidden" name="from" value="{{$from}}">
                                            <input type="hidden" name="to" value="{{$to}}">
                                            <button type="submit" class="btn btn-info" name="action" value="1">Pdf <i
                                                        class="fa fa-file-pdf-o"></i>
                                            </button>
                                            <button type="submit" class="btn btn-warning" name="action" value="2">Excel <i
