...
<table width="100%" style="padding-bottom: 10px">
    <tbody>
    <tr>
        <td style="font-size: 15px">COVER</td>
    ...
    <tr><!--row1-->
        <td colspan="3">
            ...
            <table width="80%" class="border-all" style="padding: 6px">
                <tr>
                    <td style="text-align:center;vertical-align: middle">{{ $job->created_at}}</td>
                </tr>
            </table>
        </td>
        <td></td>
    ...
    <tr>
        ...
        <td colspan="6">
            <table width="80%" class="border-all" style="padding: 6px">
                <tr>
                    <td>{{$job->customer->marketeer->mobile}}</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2" style="font-size: 13px">Cover Details</td>
