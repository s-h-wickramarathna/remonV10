@extends('layouts.master') @section('title','Cash Deposit List')
@section('css')
    ...
    <div class="col">
        <div class="col-xs-12">
            <div class="box box-widget box-list box-primary">
                <div class="box-body">
                    <form role="form" method="get" action="{{url('payment/report/cashDeposit/list')}}">
            ...
            <div class="box box-widget box-list box-primary">
                <div class="box-body" style="max-height: 500px;min-height: 500px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                            <form role="form" method="get" action="{{url('payment/report/cashDeposit/download')}}">
                            ...
                            <form role="form" method="get" action="{{url('payment/report/cashDeposit/excel')}}">
                                <div class="col-md-1 pull-right">
                                    <div class="pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <input type="hidden" name="no" value="{{$no}}">
