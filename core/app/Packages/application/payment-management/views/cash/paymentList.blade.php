...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="active">Cash Payment List</li>
    </ol>
    <div class="col">
        <div class="col-xs-12">
            <div class="box box-widget box-list box-primary">
                <div class="box-body">
                    <form role="form" method="get" action="{{url('payment/report/cashPayment/list')}}">
            ...
            <div class="box box-widget box-list box-primary">
                <div class="box-body" style="max-height: 500px;min-height: 500px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <form role="form" method="get" action="{{url('payment/report/cashPayment/download')}}">
                            ...
                            <form role="form" method="get" action="{{url('payment/report/cashPayment/excel')}}">
                                <div class="col-md-1 pull-right">
                                    <div class="pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <input type="hidden" name="no" value="{{$no}}">
