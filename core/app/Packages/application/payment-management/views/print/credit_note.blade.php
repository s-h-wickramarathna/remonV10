            ...
            <table class="details" width="100%" style="border-bottom-style:solid">
                <thead style="background-color:rgba(52, 73, 94,0.5);color:#fff;">
                    <tr>
                        ...
                        <th align="left" width="20%" class="border-top">Invoice No</th>
                        <th align="left" width="15%" class="border-top">Date</th>
                ...
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td class="border-top">{{$order->invoice->customer->f_name.' '.$order->invoice->customer->l_name}}</td>
                        <td class="border-top">{{$order->invoice_no}} </td>
                        <td class="border-top">{{$order->created_at}}</td>
                        <td class="border-top" style="text-align: right">{{number_format($order->credit_amount,2)}}</td>
                        <td class="border-top">{{$order->comment}}</td>

                    </tr>
                    <?php $i++;$total+=$order->credit_amount;?>
                @endforeach
                </tbody>
                <tfoot>
                <tfoot>
