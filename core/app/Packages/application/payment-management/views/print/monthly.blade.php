            ...
            <table class="details" width="100%" style="border-bottom-style:solid">
                <thead style="background-color:rgba(52, 73, 94,0.5);color:#fff;">
                    <tr>
                        ...
                        <th width="30%" class="border-top">Customer</th>
                ...
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td class="border-top">{{$order->recipt_no}}</td>
                ...
                <tfoot>
                    <tr>
                        <td class="border-top" colspan="4" style="font-size: 12px" align="right"><b>Total:</b></td>
                        <td class="border-top" align="right" style="font-size: 12px"><b>{{number_format($total,2)}}</b></td>
                    </tr>
                </tfoot>
            </table>
        </td>
