@extends('layouts.master') @section('title','Transaction List')
@section('css')
    ...
    <div class="col">
        <div class="col-xs-12">
            <div class="box box-widget box-list box-primary">
                <div class="box-body">
                    <form role="form" method="get" action="{{url('payment/transaction/list')}}">
                                ...
                                <div class="col-sm-3">
                                    <select class="chosen" name="cashier">
                                        ...
                                        @foreach($cashierList as $cashierObj)
                                            <option value="{{$cashierObj->id}}"
                                                    @if($cashierObj->id == $cashier ) selected @endif>{{$cashierObj->employee_->first_name .' '.$cashierObj->employee_->last_name}}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            <div class="box box-widget box-list box-primary">
                <div class="box-body" style="max-height: 500px;min-height: 500px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <form role="form" method="get" action="{{url('payment/transaction/list/download')}}">
                                <div class="col-md-1 pull-right">
                                    <div class="pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <input type="hidden" name="marketeer" value="{{$marketeer}}"> <input
                            ...
                            <form role="form" method="get" action="{{url('payment/transaction/list/excel')}}">
                                <div class="col-md-1 pull-right">
                                    <div class="pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <input type="hidden" name="marketeer" value="{{$marketeer}}"> <input
