@extends('layouts.master') @section('title','Receipt List')
@section('css')
    ...
    <div class="col">
        <div class="col-xs-12">
            <div class="box box-widget box-list box-primary">
                <div class="box-body">
                    <form role="form" method="get" action="{{url('payment/report/list')}}">
            ...
            <div class="box box-widget box-list box-primary">
                <div class="box-body" style="max-height: 500px;min-height: 500px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <form role="form" method="get" action="{{url('payment/receipt/list/download')}}">
                            ...
                            <form role="form" method="get" action="{{url('payment/receipt/list/excel')}}">
                                <div class="col-md-1 pull-right">
                                    <div class="pull-right"
                                         style="padding-right: 10px;padding-top: 10px;padding-left: 10px">
                                        <input type="hidden" name="marketeer" value="{{$marketeer}}"> <input
