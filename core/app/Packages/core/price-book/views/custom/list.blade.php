@extends('layouts.master') @section('title','Custom Price Book List')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Custom Price Book List</li>
</ol>
<div class="row">
	<div class="col-xs-12">
			          		...
			          		<table class="table table-bordered bordered table-striped table-condensed datatable" id="price_book" name="price_book">
				              	<thead>
					                <tr>
					                  	...
					                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Price Book Owners</th>
					                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Created At</th>
					                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Ended At</th>
        ...
        <div class="modal-content">
            <div class="modal-body">
            	...
            	<div class="row" style="margin: 0px !important">
	            	<table class="table table-bordered bordered table-striped table-condensed datatable" id="price_book_detail" name="price_book_detail" style="margin: 5px auto">
		              	<thead>
			                <tr>
			                  	<th rowspan="2" class="text-center">#</th>
			                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Price Book</th>
			                  	...
			                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Price</th>
			                  	<th colspan="2" class="text-center" style="font-weight:normal;">Ended At</th>
			                </tr>
			                <tr style="display: none;">
			                	<th style="display: none;"></th>
			                </tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		table1 = generateTable('#price_book', '{{url('price/custom/json/listPriceBook')}}',[],[0,1,2,3,4],[],[],[0,"asc"]);
		table2 = generateTable('#price_book_detail', '{{url('price/custom/json/listPriceBookDetail')}}/0',[],[0,1,2,3,4,5,6],[],[],[0,"asc"]);
	...
	function view_detail(id){		
		$(".panel").addClass('panel-refreshing');
		table2.ajax.url('{{url('price/custom/json/listPriceBookDetail')}}/'+id).load(function(){
            $(".panel").removeClass('panel-refreshing');
        });			
