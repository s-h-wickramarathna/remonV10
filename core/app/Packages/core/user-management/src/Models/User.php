...
class User extends Model implements PermissibleInterface, PersistableInterface, RoleableInterface, UserInterface
{
   ...
   /**
    ...
    public function role()
    {
        ...
        return $this->belongsTo('Core\UserManage\Models\RoleUsers','id','user_id');
    }
    ...
    {
        return $this->belongsTo('Application\CustomerManage\Models\Customer','id','user_id');
    }
