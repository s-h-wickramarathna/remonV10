...
<body>
  ...
  <div class="app layout-fixed-header bg-white usersession">
        ...
        <div class="center-content">
          <div class="row no-margin">
            <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
              <form role="form" action="{{URL::to('user/2-step-verification')}}" class="form-layout checkbo" method="post">
    ...
    height: 50%;" /> -->
                ...
                <p class="text-center">2-Step Verification</p>
                <p class="text-center">We have sent you a verification code to your phone.</p>
                <p class="text-center mb30">Please enter it below.</p>
                @if($errors->has('login'))
                ...
                <div class="form-inputs">
                  <input type="text" name="verification" class="form-control input-lg" placeholder="Eg: 34567" autocomplete="off" value="" autofocus>
