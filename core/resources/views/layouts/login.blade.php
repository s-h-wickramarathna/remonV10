              ...
              <form role="form" action="{{URL::to('user/login')}}" class="form-layout checkbo" method="post">
                ...
                <div class="text-center mb15">
                  <!-- <h1 style="font-weight: bold;color: #6A9A28;">WELCOME..!</h1> -->
                    ...
                    <img src="{{asset('assets/images/logo-larg.png')}}" style="width: 54%;
    height: 50%;" />
                </div>
                ...
                <div class="form-inputs">
                  <input type="text" name="username" class="form-control input-lg" placeholder="Username" autocomplete="off" value="{{{old('username')}}}" @if(empty(old('username'))) autofocus @endif>
                  <input type="password" name="password" class="form-control input-lg" placeholder="Password" @if(!empty(old('username'))) autofocus @endif>
                </div>
                <label class="cb-checkbox">
                  <input type="checkbox" name="remember" value="{{old('remember')}}" />Keep me signed in
                </label>
